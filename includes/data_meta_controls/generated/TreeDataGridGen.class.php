<?php
	 ...
	 * listing a collection of Tree objects.  It includes
	 ...
	 * 
	 */
	class TreeDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Tree datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Tree object, or it can be any QQNode extending from QQN::Tree().
		 * 
		 ...
		 * sorting using two fields from the Tree object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Tree
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Tree::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from Tree, given the clauses above
			$this->DataSource = Tree::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a Tree-based QQNode.
		 * It will also verify that it is a proper Tree-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'tree') {
