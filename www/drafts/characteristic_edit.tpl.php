<?php
	// This is the HTML template include file (.tpl.php) for the characteristic_edit.php
	// form DRAFT page.  Remember that this is a DRAFT.  It is MEANT to be altered/modified.

	// Be sure to move this out of the generated/ subdirectory before modifying to ensure that subsequent 
	// code re-generations do not overwrite your changes.

	$strPageTitle = QApplication::Translate('Characteristic') . ' - ' . $this->mctCharacteristic->TitleVerb;
...
?>
	...
	<div id="titleBar">
		<h2><?php _p($this->mctCharacteristic->TitleVerb); ?></h2>
		<h1><?php _t('Characteristic')?></h1>
	</div>
