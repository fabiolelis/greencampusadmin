<?php
	 ...
	 * @subpackage Drafts
	 */
	class CharacteristicEditPanel extends QPanel {
		...
		public function __construct($objParentObject, $strClosePanelMethod, $intIdcharacteristic = null, $strControlId = null) {
			// Call the Parent
			try {
			...
			$this->strTemplate = 'CharacteristicEditPanel.tpl.php';
			$this->strClosePanelMethod = $strClosePanelMethod;

			// Construct the CharacteristicMetaControl
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctCharacteristic = CharacteristicMetaControl::Create($this, $intIdcharacteristic);
