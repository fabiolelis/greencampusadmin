<?php
	 ...
	 * EventDataGrid control which has meta-methods to help with
	 * easily creating/defining Event columns.
	 *
	 * Any display customizations and presentation-tier logic can be implemented
	 * here by overriding existing or implementing new methods, properties and variables.
	 * 
	 * NOTE: This file is overwritten on any code regenerations.  If you want to make
	 * permanent changes, it is STRONGLY RECOMMENDED to move both event_list.php AND
	 * event_list.tpl.php out of this Form Drafts directory.
	 *
	 * @package My Application
	 * @subpackage Drafts
	 */
	class EventListForm extends QForm {
...
//		protected function Form_Validate() {}
		...
		protected function Form_Create() {
			...
			$this->dtgEvents->ItemsPerPage = 20;

			// Use the MetaDataGrid functionality to add Columns for this datagrid

			// Create an Edit Column
			$strEditPageUrl = __VIRTUAL_DIRECTORY__ . __SUBDIRECTORY__ . '/event_edit.php';
			$this->dtgEvents->MetaAddEditLinkColumn($strEditPageUrl, 'Edit', 'Edit');
