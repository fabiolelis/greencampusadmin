<?php
	 ...
	 * @subpackage Drafts
	 */
	class TreeEditForm extends QForm {
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the TreeMetaControl constructor)
	...
	// tree_edit.tpl.php as the included HTML template file
	TreeEditForm::Run('TreeEditForm');
?>